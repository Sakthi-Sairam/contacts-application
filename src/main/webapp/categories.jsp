	...
	<div class="app-container">
		...
		<div class="sidebar">
			...
			<nav class="sidebar-nav">
				...
				</a> <a class="active" href="/categories"> <i class="bi bi-tags"></i> <span>Categories</span>
				...
				<table class="table">
					...
					<tbody>
						...
						for (CategoryDetails category : categories) {
							...
							out.println("<tr>");
							out.println(String.format("<td><a href='/categories/%d' class='mybutton'>", category.getCategoryId())
							...
							out.println("</td>");
							out.println("<td>");
							out.println("    <form action='/categories/" + category.getCategoryId()
							+ "?action=delete' method='post' style='display:inline;'>");
							out.println(
