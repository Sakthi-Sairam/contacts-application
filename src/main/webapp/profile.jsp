...
<h5>Hello <%= user.getFirstName() %> <%=user.getLastName() %>...</h5>
	<img alt="profile-img" src="https://upload.wikimedia.org/wikipedia/commons/7/7c/Profile_avatar_placeholder_large.png?20150327203541">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<form action="addemail" method="post">
		    ...
		    <input type="submit" class="mybutton" value="Add Email">
		</form>
